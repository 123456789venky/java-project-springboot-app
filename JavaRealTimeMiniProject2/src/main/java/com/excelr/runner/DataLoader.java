...
import org.springframework.boot.CommandLineRunner;  // ✅ FIXED: Correct interface
...
@Component
public class DataLoader implements CommandLineRunner {  // ✅ FIXED: CommandLineRunner

    @Autowired
    private CitizenPlanRepo repo;

    @Override
    public void run(String... args) throws Exception {  // ✅ FIXED: Correct method signature
        ...
        repo.saveAll(list);
        System.out.println("✅ DataLoader completed - 12 records saved!");
    }
}
